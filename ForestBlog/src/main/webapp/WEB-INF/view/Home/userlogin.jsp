...
<div id="login">
    ...
    <form name="loginForm" id="loginForm"  method="post">
       ...
       <%-- <p class="submit">
        ...
        <p class="submit">
            <div style="width: 100px;height: 30px;float: right;line-height: 30px;">
                <input type="button" name="wp-submit" id="submit-btn" class="button button-primary button-large" value="登录" />
                <input type="button" name="wp-regist" id="regist-btn"  value="注册" />
            </div>
        </p>
...
<script type="text/javascript">
    ...
    $("#regist-btn").click(function () {
        window.location.href="/toPageRegisterUser";
    })
